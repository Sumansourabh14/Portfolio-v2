export const workExperience = [
  ...
  },
  {
    ...
    type: "Freelance",
    description: [
      "Authored technical articles on React.js, Node.js, full-stack web development, databases, and ChatGPT, amassing 1,00,000+ reads across platforms and establishing expertise in high-demand topics",
      "Crafted in-depth content (1,500+ words per article) optimized with on-page SEO best practices and editorial guidelines.",
    ],
